                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown"
                            ...
                            <div class="nav-profile-text">
                                ...
                                </span><span class="user-status">{{ $user->user_role->role }}</span>
                            </div>
                        </a>
            ...
            <div class="main-panel">
                                ...
                                <div class="row">
                                    <div class="col-xl-5 col-lg-12 media mb-2">
                                        ...
                                        <div class="media-body mt-50">
                                            <h4 class="text-danger">{{ $user->name }}</h4>
                ...
                <div class="row">
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Status Yang Sedang Login ke admin
                                </h4>
                                <p class="text-danger"><b>MERAH</b></p>
                                <div class="col-xl-7 col-lg-12 mt-2 mt-xl-0">
